...
import static com.offline.jambguide.activity.QuizActivity.bookmarkDBHelper;
            ...
            bookmark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (bookmark.getTag().equals("unmark")) {
                        String solution = QuizActivity.DBHelper.getQuestionSolution(reviews.get(questionIndex).getQueId());
                        ...
                        QuizActivity.bookmarkDBHelper.delete_id(reviews.get(questionIndex).getQueId());
